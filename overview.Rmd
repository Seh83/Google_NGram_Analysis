...
kable(fitSet02.dt[c(74, 126, 161, 123),], digits=2)
```

The next is a look at the rows returned by Cook's Distance.
...
kable(fitSet02.dt[c(28, 74, 123),], digits=2)
```
...
kable(fitSet02.dt[c(28, 74, 96, 123),], digits=2)
```
